...
Item {
    ...
    Component.onCompleted: {
        infoModel.append({ name: i18n.tr("Get the source"), url: "https://github.com/dark-eye/miracast" })
        infoModel.append({ name: i18n.tr("Report issues"), url: "https://github.com/dark-eye/miracast/issues" })
